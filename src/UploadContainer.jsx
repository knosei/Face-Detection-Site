...
const UploadContainer = () => {
  ...
  return (
    <div className="relative h-screen">
      ...
      {showImageContainer && (
        <div className="absolute inset-0 flex justify-center items-center bg-gray-800 bg-opacity-50 backdrop-blur-3xl">
          <div className="bg-white p-4 rounded-lg text-center">
            <img
              src={previewUrl}
              alt="Uploaded Image"
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="bg-gray-00 p-4 rounded-full w-[500px] h-[50px] ">
          <label
            htmlFor="file-upload"
            className="cursor-pointer flex justify-between items-center w-[500px] h-[50px] p-4 border border-dashe rounded-full border-gray-400 hover:border-blue-600"
          >
            {previewUrl ? (
              <img src={previewUrl} alt="Preview" className="w-100 h-100 mx-auto" />
            ) : (
              <>
              <p className="text-gray-900 hover:text-blue-700">Upload a photo</p>
